    ...
    if (feature.properties) {
        ...
        if(feature.properties["Employees_Link"]){
            ...
            <div class="featureInfo is-center">
                <a href="${feature.properties["Employees_Link"]}" target="_parent" class="button secondary Employees_Link">see who worked here</a>
            </div>`
        }
...
let answer = prompt("This page is not intended for just anyone.\n Please provide the password.")
if(answer == "SuperSecret") VIEWER.init()
else {kastorMap.innerHTML = "<h1> Incorrect password.  You may not view this page. </h1>"}
